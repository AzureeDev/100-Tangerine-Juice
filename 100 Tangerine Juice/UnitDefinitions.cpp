...
void UnitDefinitions::createDefinitions()
{
	...
	suguri.unitDesc = "Suguri is a high-risk, high-reward unit. She's able to gather more stars from Bonus panels, and have decent battle stats. Beware, loosing in battles could cost you the victory.";
	...
	sora.unitId = "sora";
	sora.unitName = "Sora";
	sora.unitDesc = "Sora is a balanced unit. Her skills are often relying on boosting her own stats rather speeding up through the end of the Road.";
	sora.unitMaxHealth = 5;
	sora.unitStats = { 1, 0, 1, 5, 1, 5 };

	UnitParams sora_m;
	sora_m.unitId = "sora_m";
	sora_m.unitName = "Sora";
	...
	hime.unitId = "hime";
	hime.unitName = "Hime";
	hime.unitDesc = "Hime is having the same passive as Suguri, which means she gather more stars from Bonus panels. Her battle stats are lowered though, making her less effective in battles.";
	...
	tsih.unitId = "tsih";
	tsih.unitName = "Tsih";
	tsih.unitDesc = "Tsih is having the unique ability to have a bonus of 1 on her movement roll. Her skills are about survivability.";
	...
	sb.unitDesc = "Star Breaker is focused on pure damage. Her insane stats allows her to put down any other unit easily, but her wins won't make other units loose stars.";
	sb.unitMaxHealth = 5;
